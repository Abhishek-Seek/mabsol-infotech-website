      ...
      <section className="max-w-[1300px] mx-auto px-6 py-16 leading-relaxed space-y-6">
        ...
        <p>
          ...
          <span className="text-blue-600 font-semibold">
            {" "}
            <a href="">https://mabsolinfotech.in</a>
          </span>
          .
        </p>
        ...
        <p>
          We employ the use of cookies. By accessing MABSOL INFOTECH, you agreed
          to use cookies in agreement with the MABSOL INFOTECH PRIVATE LIMITED’s
          Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, MABSOL INFOTECH PRIVATE LIMITED and/or its
          licensors own the intellectual property rights for all material on
          MABSOL INFOTECH. All intellectual property rights are reserved. You
          may access this from MABSOL INFOTECH for your own personal use
        ...
        <p>
          ...
          MABSOL INFOTECH PRIVATE LIMITED does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do
          not reflect the views and opinions of MABSOL INFOTECH PRIVATE
          ...
          extent permitted by applicable laws, MABSOL INFOTECH PRIVATE LIMITED
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          MABSOL INFOTECH PRIVATE LIMITED reserves the right to monitor all
        ...
        <p>
          You hereby grant MABSOL INFOTECH PRIVATE LIMITED a non-exclusive
        ...
        <p>
          ...
          the hyperlink compensates the absence of MABSOL INFOTECH PRIVATE
        ...
        <p>
          ...
          sending an e-mail to MABSOL INFOTECH PRIVATE LIMITED. Please include
        ...
        <p>
          No use of MABSOL INFOTECH PRIVATE LIMITED’s logo or other artwork will
        ...
        <h3 className="text-2xl font-semibold text-[#185e9a]">Your Privacy</h3>
        <p>
          Please read our{" "}

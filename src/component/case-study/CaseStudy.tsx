        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 lg:px-60 py-20'>
            ...
            <Card data-aos="fade-left" className='!bg-gray-200'>
                ...
                <p className='pt-4 italic text-lg'>
                    At Mabsol Infotech, we’re committed to enhancing business operations through our innovative software solutions.
                    Explore how our tailored software applications
                    have empowered diverse industries to streamline their processes and achieve remarkable results.
                </p>
                ...
                <p className='pt-4 italic text-lg'>
                    These case studies highlight how Mabsol Infotech’s solutions address specific challenges and deliver tangible results,
                    demonstrating our commitment to enhancing business performance across various sectors.
                </p>
            </Card>
        </div>
    )
